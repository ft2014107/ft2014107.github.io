function ep01a() {
			document.getElementById('mainvideo').src='https://v.ini0.com/player/?url=https://pan.bilnn.cn/api/v3/file/sourcejump/9yrwXLCo/2gUEo08CzcmMxcRGm_BV43lpVclAU0P2ClY1xywg11s*';
			document.getElementById('titlehe').innerHTML='格林一家进城趣 S01E01a 欢迎回家';
				}
function ep01b() {
			document.getElementById('mainvideo').src='https://v.ini0.com/player/?url=https://pan.bilnn.cn/api/v3/file/sourcejump/xqgLvKhe/tBKQRX6YI-hBZNaGoJuEixu72QoOJaPOVvJx0X7sdbw*';
			document.getElementById('titlehe').innerHTML='格林一家进城趣 S01E01b 太空飞鸡';
				}
function ep02a() {
			document.getElementById('mainvideo').src='https://v.ini0.com/player/?url=https://pan.bilnn.cn/api/v3/file/sourcejump/xqgzA7Fe/IFrzY4YPjxTND33Y3yOPC458EoJcEhEZxo4XqyB5u2Q*';
			document.getElementById('titlehe').innerHTML='格林一家进城趣 S01E02a 牛排之夜';
				}
function ep02b() {
			document.getElementById('mainvideo').src='https://v.ini0.com/player/?url=https://pan.bilnn.cn/api/v3/file/sourcejump/E5rBYri9/SHV1UQ4PBQFpVMVUP-1c1bAPPEikpoXYb4v-oF2LlfE*';
			document.getElementById('titlehe').innerHTML='格林一家进城趣 S01E02b 蟋蟀的挑战';
				}
function ep03a() {
			document.getElementById('mainvideo').src='https://v.ini0.com/player/?url=https://pan.bilnn.cn/api/v3/file/sourcejump/YGMKZxFv/ZzjVEzeFRNdFNe0NxaaCYpP898YPgPw7QdwxXaQZiKk*';
			document.getElementById('titlehe').innerHTML='格林一家进城趣 S01E03a 游泳池';
				}
function ep03b() {
			document.getElementById('mainvideo').src='https://v.ini0.com/player/?url=https://pan.bilnn.cn/api/v3/file/sourcejump/LWrG9wiM/qxUt03Ay54tMid-ZCklm1dtvU0LOZKZYbWdl8dmUrkQ*';
			document.getElementById('titlehe').innerHTML='格林一家进城趣 S01E03b 提莉的山羊';
				}
function ep04a() {
			document.getElementById('mainvideo').src='https://v.ini0.com/player/?url=https://pan.bilnn.cn/api/v3/file/sourcejump/6WoZkXig/YbcgOAUSMyYvtVqcvJKlu15Vnyn25iibgOPpsiZsrDQ*';
			document.getElementById('titlehe').innerHTML='格林一家进城趣 S01E04a 小球危机';
				}
function ep04b() {
			document.getElementById('mainvideo').src='https://v.ini0.com/player/?url=https://pan.bilnn.cn/api/v3/file/sourcejump/Md6nlzcv/y5v6otIgkRenAjxKwBsNizbmb6-ss-DyH0iHcUdX7zw*';
			document.getElementById('titlehe').innerHTML='格林一家进城趣 S01E04b 浣熊入侵';
				}
function ep05a() {
			document.getElementById('mainvideo').src='https://v.ini0.com/player/?url=https://pan.bilnn.cn/api/v3/file/sourcejump/YG6DvLHv/UFhnXabYJUTrajlIONbz2aHkMmC0CVPFWLjw61gX84Q*';
